			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<form:form action="/admin/sizeForm/form" method="post"
								modelAttribute="sizeModel" enctype="multipart/form-data">

								<div class="form-group">
									<label for="inputState">Kích thước</label>
								...
								<button formaction="/admin/sizeForm/list" formmethod="get"
